				...
				<div class="wrap-login100">
					...
					<div class="login100-form validate-form">
						...
						<div class="wrap-input100 validate-input">
							<input class="input100" id="teacherCode" type="text" name="teacherCode" placeholder="Kode Guru" required>
							<span class="focus-input100"></span>
							<span class="symbol-input100">
								<i class="fa fa-user-circle-o" aria-hidden="true"></i>
							</span>
							<span class="error text-danger" id="empty_teacher_code_field"></span>
						</div>

						<div class="wrap-input100 validate-input">
							<input class="input100" id="teacherPassword" type="password" name="password" placeholder="Password" required>
							<span class="focus-input100"></span>
							<span class="symbol-input100">
								<i class="fa fa-lock" aria-hidden="true"></i>
							</span>
							<span class="error text-danger" id="empty_teacher_password_field"></span>
						</div>
	...
	<script>
		...
		function login() {
			...
			if (!$('#teacherCode').val()) {
				...
				$('#empty_teacher_code_field').val("Please enter your teacher code");
			}
			if (!$('#teacherPassword').val()) {
				someFieldIsEmpty = true;
				$('#empty_teacher_password_field').val("Please enter your password");
			}
