      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">View Schedule Data</a>
          </div>
          ...
          <div class="col-md-12">
            <div class="card" style="min-height:400px;">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-8">
                    <h5 class="title">All Schedule Data</h5>
                  </div>
                  <div class="col-md-2">
                ...
                <table id="schedule_table">
                  <thead>
                    <tr>
                      ...
                      <th data-field="sesi">Sesi</th>
                      <th data-field="ruangan">Ruangan</th>
                      <th data-field="penguji">Penguji</th>
...
<script>
  ...
  function populateTable() {
    $.ajax({
      type: 'POST',
      url: 'get_schedules_from_theme.php',
      data: {
  ...
  function TableActions(value, row, index) {
    curID = row["id"];
    return [
      '<button class="btn btn-primary btn-block btn-round" onclick="edit_student(curID)" style="margin-top:0px;width:100px !important;float:left !important;">Edit</button>',
      '<button class="btn btn-danger btn-block btn-round" onclick="delete_student(curID)" style="margin-top:0px;margin-left:10px;width:100px !important;float:left !important;">Delete</button>'
    ].join('');
  }
