  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">View Groups Data</a>
          </div>
          ...
          <div class="col-md-12">
            <div class="card" style="min-height:400px;">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-8">
                    <h5 class="title">All Groups Data</h5>
                  </div>
                  <div class="col-md-2">
                  ...
                  <div class="col-md-2">
                  <button onclick = 'redirect_to_new_group()' class="btn btn-primary btn-block btn-round" style="margin-top:0px;width:100px !important;float:right !important;">NEW</button> 
                ...
                <!-- <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> -->
                  ...
                  <thead>
                      <tr>
                          ...
                          <th data-field="kelompok">Group</th>
                          <th data-field="anggota">Anggota</th>
      ...
      <form method="POST" action="delete_data.php" id="delete_data">
        ...
        <input type="hidden" name="data_table_delete" value="group">
      </form>

      <form method="POST" action="group_new.php" id="edit_data">
...
var total_count;
  ...
  function populateTable(){
    $.ajax({
						type: 'POST',
						url: 'get_groups_from_class.php',
            data : {
              'class_name' : $('#options option:selected').val(),
            },
            datatype : 'json',
						success: function (response) {
              $('#groups_table').bootstrapTable('destroy');
              var jsondata = JSON.parse(response);
                $('#groups_table').bootstrapTable({
                  data:jsondata,
                });
          }
    });
  ...
  function TableActions(value, row, index) {
    curID = row["id"];
    return [
      '<button class="btn btn-primary btn-block btn-round" onclick="edit_group(curID)" style="margin-top:0px;width:100px !important;float:left !important;">Edit</button>',
      '<button class="btn btn-danger btn-block btn-round" onclick="delete_group(curID)" style="margin-top:0px;margin-left:10px;width:100px !important;float:left !important;">Delete</button>'
    ].join('');
  }

  function redirect_to_new_group() {
