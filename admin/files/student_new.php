      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Students</a>
          </div>
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Create New Student</h5>
              </div>
              <div class="card-body">
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                  ...
                  if(isset($_POST['data_id_edit'])) {
                    ...
                    <div class="row center-element">
                      <div class="col-md-8">
                        <div class="form-group">
                          <button class="btn btn-primary btn-block btn-round">UPDATE STUDENT</button>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label>Student NIS</label>
                            <input type="text" class="form-control" name="nis" placeholder="Student NIS" required/>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label>Student JK</label>
                          <select id="options" name="jk" class="btn-round" required style="width:100%;">
                              <option selected="true" value="" disabled="disabled">Select jk for student</option> 
                              <option value="1">Laki-laki</option>     
                              <option value="0">Perempuan</option>      
                            </select>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label>Student Class</label>
                            <select id="options" name="class_id" class="btn-round" required style="width:100%;">
                              <option selected="true" value="" disabled="disabled">Select class for student</option>
                              <?php
                    ...
                    <div class="row center-element">
                      <div class="col-md-8">
                        <div class="form-group">
                          <button class="btn btn-primary btn-block btn-round">CREATE STUDENT</button>
                        </div>
                      </div>
                    </div>
