      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Add Group</a>
          </div>
      ...
      <div class="content" style="min-height: auto;">
        <div class="row">
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Add New Group Data</h5>
              </div>
              <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id = "class_name" name="site_name" placeholder="Group name"/>
                        <span id = "class_name_error" class="error text-danger"></span>
                      </div>
                      <div class="form-group">
                        <label>Kelas</label>
                        <input type="text" class="form-control" id = "starting_roll_number" name="site_name" placeholder="Nama Kelas"/>
                  ...
                  <div class="row center-element">
                    <div class="col-md-8">
                      <div class="form-group"><br/>
                        <button class="btn btn-primary btn-block btn-round" onclick = 'createNewGroup()'>CREATE</button>
                      </div>
                    </div>
                  </div>
                <!-- </form> -->
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Add Student to Group</h5>
              </div>
              <div class="card-body">
                  <input type="hidden" name="general_settings">
                  <div class="row">
                    <div class="col-md-12">
                        <select id="options" name="class_option" class="btn-round" required style="width:100%;">
                            <option selected="true" value="" disabled="disabled">Select group</option>      
                        </select>
                        <span id = "extra_roll_class_error" class="error text-danger"></span>

                        <select id="options2" name="class_option" class="btn-round" required style="width:100%; margin-top:10px;">
                            <option selected="true" value="" disabled="disabled">Select student</option>      
                        </select>
                        <span id = "extra_roll_class_error" class="error text-danger"></span>
                  ...
                  <div class="row center-element">
                    <div class="col-md-8">
                      <div class="form-group"><br/>
                        <button class="btn btn-primary btn-block" onclick = 'addStudentToGroup()'>ADD</button>
                      </div>
                    </div>
                  </div>
                <!-- </form> -->
  ...
  <script>
    ...
    $( document ).ready(function() {
      ...
      $.ajax({
              ...
              var opts = $.parseJSON(response);
                $.each(opts, function(i, d) {
                    $('#options2').append('<option value="' + d + '">' + d + '</option>');
                });
						}
					});
    });
    ...
    function createNewGroup(){
      ...
      if(!$('#class_name').val()){
          $('#class_name_error').html("Please enter Group Name");
          someValidationFailed = true;
      }

      if(!$('#starting_roll_number').val()){
        $('#starting_roll_error').html("Please enter Kelas Group number");
        someValidationFailed = true;
      }
      ...
      $.ajax({
          type: 'POST',
          url: 'add_new_group.php',
          data: {
            'group_name': $('#class_name').val(),
            'kelas': $('#starting_roll_number').val()
          },
          success: function (response) {
            alert(response);
          }
